...
const TelaInicial = () => {
  ...
  return (
    <>
      <Link to="/" className="back-button" style={{zIndex: 15, position: 'absolute', top: '20px', left: '20px', color: 'white', textDecoration: 'none', fontSize: '1.2rem'}}>
        ← Voltar
      </Link>
      ...
      <main className="tela-inicial">
        ...
        {/* --- O BOTÃO PARA O QUIZ FOI REMOVIDO DESTA ÁREA --- */}
